...
//    }
//
//    private int rateClosedQuestions(JsonNode answers) {
//        int points = 0;
...
//        String answers = JsonController.getAnswersAsJson(rootNode.get("answers"));
//
//        String result = "[";
...
//                String answersAsText = JsonController.getAnswersAsJson(candidate.get("answers"));
//                result += "{" +
