...
(ten responseText jeszcze w backendzie będzie zrobiony czytelniejszym pewnie, żeby łatwo było wyciągać poszczególne atrybuty we froncie i je wyświetlać)

responseText: "{\n  \"max_points\" : 3,\n  \"min_points\" : 2,\n  \"questions\" : [ {\n    \"question_type\" : \"W\",\n    \"answers\" : [ {\n      \"answer\" : \"tak\",\n      \"correct\" : false\n    }, {\n      \"answer\" : \"nie\",\n      \"correct\" : true\n    } ],\n    \"question_content\" : \"Czy Ziemia jest płaska?\"\n  }, {\n    \"question_type\" : \"L\",\n    \"correct_answer\" : 8,\n    \"question_content\" : \"Ile wynosi (2+2)*2?\"\n  }, {\n    \"question_type\" : \"O\",\n    \"question_content\" : \"Opisać zjawisko indukcji elektromagnetycznej.\"\n  } ],\n  \"recruiter_id\" : \"jakaś nazwa użytkownika-rekrutera czy coś\",\n  \"test_id\" : \"jakaś wartość szesnastkowa czy coś\"\n}{\n  \"max_points\" : 3,\n  \"min_points\" : 2,\n  \"questions\" : { },\n  \"recruiter_id\" : \"jakaś nazwa użytkownika-rekrutera czy coś\",\n  \"test_id\" : \"jakaś wartość szesnastkowa czy coś123\"\n}{\n  \"max_points\" : 3,\n  \"min_points\" : 2,\n  \"questions\" : [ {\n    \"question_type\" : \"W\",\n    \"answers\" : [ {\n      \"answer\" : \"tak\",\n      \"correct\" : false\n    }, {\n      \"answer\" : \"nie\",\n      \"correct\" : true\n    } ],\n    \"question_content\" : \"Czy Ziemia jest płaska?\"\n  }, {\n    \"question_type\" : \"L\",\n    \"correct_answer\" : 8,\n    \"question_content\" : \"Ile wynosi (2+2)*2?\"\n  }, {\n    \"question_type\" : \"O\",\n    \"question_content\" : \"Opisać zjawisko indukcji elektromagnetycznej.\"\n  } ],\n  \"recruiter_id\" : \"jakaś nazwa użytkownika-rekrutera czy coś\",\n  \"test_id\" : \"jakaś wartość szesnastkowa czy coś352\"\n}{\n  \"max_points\" : 3,\n  \"min_points\" : 2,\n  \"recruiter_id\" : \"jakaś nazwa użytkownika-rekrutera czy coś\",\n  \"test_id\" : \"jakaś wartość szesnastkowa czy coś5512521\"\n}{\n  \"max_points\" : 3,\n  \"min_points\" : 2,\n  \"questions\" : [ {\n    \"question_type\" : \"O\",\n    \"question_content\" : \"Rozwiąż zadanie [treść].\"\n  }, {\n    \"question_type\" : \"W\",\n    \"answers\" : [ {\n      \"answer\" : \"tak\",\n      \"correct\" : false\n    }, {\n      \"answer\" : \"nie\",\n      \"correct\" : true\n    } ],\n    \"question_content\" : \"Czy Ziemia jest płaska?\"\n  }, {\n    \"question_type\" : \"L\",\n    \"correct_answer\" : 8,\n    \"question_content\" : \"Ile wynosi (2+2)*2?\"\n  }, {\n    \"question_type\" : \"W\",\n    \"answers\" : [ {\n      \"answer\" : \"1880\",\n      \"correct\" : false\n    }, {\n      \"answer\" : \"1892\",\n      \"correct\" : false\n    }, {\n      \"answer\" : \"1889\",\n      \"correct\" : true\n    } ],\n    \"question_content\" : \"W którym roku urodził się Adolf Hitler?\"\n  }, {\n    \"question_type\" : \"O\",\n    \"question_content\" : \"Opisać zjawisko indukcji elektromagnetycznej.\"\n  }, {\n    \"question_type\" : \"L\",\n    \"correct_answer\" : 64,\n    \"question_content\" : \"Ile wynosi 8*8?\"\n  } ],\n  \"recruiter_id\" : \"tester22112019\",\n  \"test_id\" : \"test221120191222\"\n}{\n  \"max_points\" : 10,\n  \"min_points\" : 6,\n  \"recruiter_id\" : \"pierwszy_rekruter\",\n  \"test_id\" : \"6034860394\"\n}{\n  \"max_points\" : 3,\n  \"min_points\" : 2,\n  \"questions\" : [ {\n    \"question_type\" : \"W\",\n    \"answers\" : [ {\n      \"answer\" : \"tak\",\n      \"correct\" : false\n    }, {\n      \"answer\" : \"nie\",\n      \"correct\" : true\n    } ],\n    \"question_content\" : \"Czy Ziemia jest płaska?\"\n  }, {\n    \"question_type\" : \"L\",\n    \"correct_answer\" : 8,\n    \"question_content\" : \"Ile wynosi (2+2)*2?\"\n  }, {\n    \"question_type\" : \"O\",\n    \"question_content\" : \"Opisać zjawisko indukcji elektromagnetycznej.\"\n  } ],\n  \"recruiter_id\" : \"tester29112019\",\n  \"test_id\" : \"test291120191315\"\n}{\n  \"recruiter_id\" : \"deed\",\n  \"test_id\" : \"avavsavsasvasa\"\n}"
...
3.w API Mapping Template to wygląda tak (nie ma tu testId, bo obstawiam, że będzie generowany w backendzie, np. test+nr+data+czas, 
bo jako RangeKey MUSI być unikalny, 
PrimaryKey (recruiter_id) ma być taki sam, bo jeden rekruter może tworzyć wiele testów):
